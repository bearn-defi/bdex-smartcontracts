...
interface BdexRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class BdexRouter extends Contract {
  ...
  functions: {
    ...
    "multihopBatchSwapExactIn(tuple[][],address,address,uint256,uint256,uint256)"(
      swapSequences: {
        pool: string;
        tokenIn: string;
        tokenOut: string;
    ...
    "multihopBatchSwapExactOut(tuple[][],address,address,uint256,uint256)"(
      swapSequences: {
        pool: string;
        tokenIn: string;
        tokenOut: string;
