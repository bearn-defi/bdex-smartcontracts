...
interface IBdexPairInterface extends ethers.utils.Interface {
  functions: {
...
export class IBdexPair extends Contract {
  ...
  functions: {
    ...
    getCollectedFees(overrides?: CallOverrides): Promise<{
    ...
    getTokenWeights(overrides?: CallOverrides): Promise<{
      tokenWeight0: number;
      tokenWeight1: number;
      0: number;
      1: number;
  ...
  filters: {
    ...
    PaidProtocolFee(collectedFee0: null, collectedFee1: null): EventFilter;
