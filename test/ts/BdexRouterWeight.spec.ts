  ...
  describe("swap with different weight", () => {
    ...
    describe("swapExactTokensForTokens", () => {
      ...
      it("gas", async () => {
        ...
        expect(receipt.gasUsed).to.eq(133261);
      });
    });
    ...
    describe("swapTokensForExactTokens", () => {
      ...
      it("gas", async () => {
        ...
        const receipt = await tx.wait();
        expect(receipt.gasUsed).to.eq(136118);
      });
    });
...
describe("fee-on-transfer tokens: reloaded", () => {
  ...
  beforeEach(async function () {
    ...
    pair = BdexPairFactory.connect(pairAddress, wallet);
  });
...
describe("tokens: multiple path", () => {
  ...
  beforeEach(async function () {
    ...
    pair2 = BdexPairFactory.connect(pair2Address, wallet);
  });
...
describe("fee-on-transfer tokens: multiple path", () => {
  ...
  beforeEach(async function () {
    ...
    pair1 = BdexPairFactory.connect(pair1Address, wallet);
    ...
    pair3 = BdexPairFactory.connect(pair3Address, wallet);
    ...
    pair4 = BdexPairFactory.connect(pair4Address, wallet);
  });
